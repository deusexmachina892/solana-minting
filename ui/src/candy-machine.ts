...
export const getCandyMachineState = async (
  ...
  console.log('wallet', anchorWallet.publicKey.toString());
  console.log('candyId', candyMachineId.toString());
  ...
  const getProgramState = async (): Promise<[anchor.Program, any]> => {
    ...
    console.log("candyId", candyMachineId)
  ...
  console.log('program', program, state)
